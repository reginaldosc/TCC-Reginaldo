...
class Auditoria extends CI_Controller {
	...
	/**
	 * Recupera as informacoes da view execAuditoria e carrega o model para gravar no banco os dados
	 */
	public function cadastrarExecAuditoria() 
	{
		...
		$data['auditoriaID']					= $this->input->post('Index');

		$data['auditoriaAcompanhante']			= $this->input->post('Acompanhante');

		//$data['auditoriaStatus']				= 'Realizada';

		//$data['auditoriaDataFinal']				= '02/09/1990';
		
		$data['artefatoNome']					= $this->input->post('optionsRadios{artefatoID}');

		$data['artefatoStatus']					= $this->input->post('statusArtefato{artefatoID}');
