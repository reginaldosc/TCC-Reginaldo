	...
	<div class="container">
		...
		?>
			...
			<fieldset>
				...
				<div class="controls">
					<input type="hidden" class="input-xlarge" id="ID" value='{artefatoID}' name="ID">
				</div>
				</div>
				...
				<div class="controls">
					<input type="text" class="input-xlarge" id="Nome" value='{artefatoNome}' name="Nome" rel="popover" 
				...
				<div class="controls">
					<input type="text" class="input-xlarge" id="Descricao" value='{artefatoDescricao}'name="Descricao" rel="popover" 
